...
if ($resultat) {
    // Afficher les lignes de la base de données
    while ($ligne = $resultat->fetch(PDO::FETCH_ASSOC)) {
        echo "adresse : " . $ligne['adresse'] . " | Nom : " . $ligne['nom'] . "<br>";
    }
}
...
<nav class="navbar navbar-expand-sm navbar-light" id="neubar">
            ...
            <ul class="navbar-nav ms-auto ">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <li><a class="dropdown-item" href="ajout-festival.php">ajout d'un festival</a></li>
                </ul>
              </li>
              <li class="nav-item">
    ...
    <div class="titre">
        <section id="rechercher">
          <h3><b>Mon espace personnel</b></h3>
