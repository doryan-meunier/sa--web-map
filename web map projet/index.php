...
$stmt = $pdo->prepare("SELECT nom, adresse, latitude, longitude FROM festival");
$stmt->execute();
$festivals = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Convertir en format JSON
$jsonResponse = json_encode($festivals);
...
<!-- Ajoutez cette balise script pour afficher le JSON dans la console -->
<script>
    console.log(<?php echo $jsonResponse; ?>);
</script>
